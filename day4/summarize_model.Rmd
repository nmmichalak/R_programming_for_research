...
C3T3 <- C3T3 %>% 
  mutate(plsntVneut = condition_lbl %>% recode("Pleasant/elated" = 1 / 2, "Neutral" = -1 / 2, "Unpleasant/depressed" = 0),
         plsntneutVunplsnt = condition_lbl %>% recode("Pleasant/elated" = 1 / 4, "Neutral" = 1 / 4, "Unpleasant/depressed" = -1 / 2))
...
Garcia <- Garcia %>% 
  mutate(protest_lbl = protest %>% recode(`0` = "no protest", `1` = "individual protest", `2` = "collective protest"),
         protestVnone = protest_lbl %>% recode("no protest" = -1 / 2, "individual protest" = 1 / 4, "collective protest" = 1 / 4),
         indvVclct = protest_lbl %>% recode("no protest" = 0, "individual protest" = -1 / 2, "collective protest" = 1 / 2))
