...
```
## # A tibble: 9 x 9
##    X1.x    id cond      gratitude_t1 interdep  X1.y gratitude_t2
##   <int> <int> <chr>            <dbl>    <dbl> <int>        <dbl>
## 1     1     1 Treatment         3.35     3.89     1         5.05
## 2     2     2 Treatment         4.76     3.88     2         4.55
## 3     3     3 Treatment         5.53     4.18     3         4.76
## 4     4     4 Treatment         2.27     1.60     4         5.56
## 5     5     5 Treatment         4.91     4.16     5         6.41
## 6     6     6 Control           4.98     3.64     6         5.40
## 7     7     7 Control           3.95     2.44     7         5.01
## 8     8     8 Control           3.98     3.47     8         4.63
## 9     9     9 Control           3.96     2.66     9         4.70
...
```
## # A tibble: 1 x 9
##    X1.x    id cond    gratitude_t1 interdep  X1.y gratitude_t2 interdep_c
##   <int> <int> <chr>          <dbl>    <dbl> <int>        <dbl>      <dbl>
## 1     9     9 Control         3.96     2.66     9         4.70     -0.664
## # ... with 1 more variable: cond2 <chr>
```
...
##    X1.x    id cond     gratitude_t1 interdep  X1.y gratitude_t2 interdep_c
##   <int> <int> <chr>           <dbl>    <dbl> <int>        <dbl>      <dbl>
## 1     1     1 Treatme~         3.35     3.89     1         5.05      0.567
## 2     2     2 Treatme~         4.76     3.88     2         4.55      0.555
## 3     3     3 Treatme~         5.53     4.18     3         4.76      0.856
## 4     4     4 Treatme~         2.27     1.60     4         5.56     -1.73 
## 5     5     5 Treatme~         4.91     4.16     5         6.41      0.833
## 6     6     6 Control          4.98     3.64     6         5.40      0.315
## # ... with 1 more variable: cond2 <chr>
```
...
## 5     5     5 Treatme~         4.91     4.16     5         6.41      0.833
## 6     6     6 Control          4.98     3.64     6         5.40      0.315
## 7     7     7 Control          3.95     2.44     7         5.01     -0.884
## # ... with 1 more variable: cond2 <chr>
```
...
## 1     1     1 Treatme~         3.35     3.89     1         5.05      0.567
## 2     2     2 Treatme~         4.76     3.88     2         4.55      0.555
## 3     7     7 Control          3.95     2.44     7         5.01     -0.884
## # ... with 1 more variable: cond2 <chr>
```
...
## 5     5     5 Treatme~         4.91     4.16     5         6.41      0.833
## 6     6     6 Control          4.98     3.64     6         5.40      0.315
## 7     9     9 Control          3.96     2.66     9         4.70     -0.664
## # ... with 1 more variable: cond2 <chr>
```
...
##    X1.x    id cond     gratitude_t1 interdep  X1.y gratitude_t2 interdep_c
##   <int> <int> <chr>           <dbl>    <dbl> <int>        <dbl>      <dbl>
## 1     2     2 Treatme~         4.76     3.88     2         4.55      0.555
## 2     3     3 Treatme~         5.53     4.18     3         4.76      0.856
## 3     5     5 Treatme~         4.91     4.16     5         6.41      0.833
## 4     6     6 Control          4.98     3.64     6         5.40      0.315
## # ... with 1 more variable: cond2 <chr>
```
...
##    X1.x    id cond    gratitude_t1 interdep  X1.y gratitude_t2 interdep_c
##   <int> <int> <chr>          <dbl>    <dbl> <int>        <dbl>      <dbl>
## 1     6     6 Control         4.98     3.64     6         5.40      0.315
## 2     7     7 Control         3.95     2.44     7         5.01     -0.884
## 3     8     8 Control         3.98     3.47     8         4.63      0.149
## 4     9     9 Control         3.96     2.66     9         4.70     -0.664
## # ... with 1 more variable: cond2 <chr>
```
...
## 3     8     8 Control          3.98     3.47     8         4.63      0.149
## 4     9     9 Control          3.96     2.66     9         4.70     -0.664
## 5     1     1 Treatme~         3.35     3.89     1         5.05      0.567
## 6     2     2 Treatme~         4.76     3.88     2         4.55      0.555
## 7     3     3 Treatme~         5.53     4.18     3         4.76      0.856
## 8     4     4 Treatme~         2.27     1.60     4         5.56     -1.73 
## 9     5     5 Treatme~         4.91     4.16     5         6.41      0.833
## # ... with 1 more variable: cond2 <chr>
```
...
## 6     6     6 Control          4.98     3.64     6         5.40      0.315
## 7     7     7 Control          3.95     2.44     7         5.01     -0.884
## 8     8     8 Control          3.98     3.47     8         4.63      0.149
## 9     9     9 Control          3.96     2.66     9         4.70     -0.664
## # ... with 1 more variable: cond2 <chr>
```
...
##    X1.x    id cond     gratitude_t1 interdep  X1.y gratitude_t2 interdep_c
##   <int> <int> <chr>           <dbl>    <dbl> <int>        <dbl>      <dbl>
## 1     7     7 Control          3.95     2.44     7         5.01     -0.884
## 2     9     9 Control          3.96     2.66     9         4.70     -0.664
## 3     8     8 Control          3.98     3.47     8         4.63      0.149
## 4     6     6 Control          4.98     3.64     6         5.40      0.315
## 5     4     4 Treatme~         2.27     1.60     4         5.56     -1.73 
## 6     2     2 Treatme~         4.76     3.88     2         4.55      0.555
## 7     1     1 Treatme~         3.35     3.89     1         5.05      0.567
## 8     5     5 Treatme~         4.91     4.16     5         6.41      0.833
## 9     3     3 Treatme~         5.53     4.18     3         4.76      0.856
## # ... with 1 more variable: cond2 <chr>
```
...
```
## # A tibble: 9 x 7
##    X1.x    id cond      gratitude_t1  X1.y interdep_c cond2  
##   <int> <int> <chr>            <dbl> <int>      <dbl> <chr>  
## 1     1     1 Treatment         3.35     1      0.567 Family 
## 2     2     2 Treatment         4.76     2      0.555 Family 
## 3     3     3 Treatment         5.53     3      0.856 Family 
## 4     4     4 Treatment         2.27     4     -1.73  Friends
## 5     5     5 Treatment         4.91     5      0.833 Friends
## 6     6     6 Control           4.98     6      0.315 Family 
## 7     7     7 Control           3.95     7     -0.884 Family 
## 8     8     8 Control           3.98     8      0.149 Friends
## 9     9     9 Control           3.96     9     -0.664 Friends
```
...
final_data_untidy <- ungroup(mutate(rowwise(final_data_untidy), cond2 =   ifelse((cond == "Treatment" & id <= 3) | (cond == "Control" & id <= 7), "Family",
                 ifelse((cond == "Treatment" & id <= 5) | (cond == "Control" & id                   >= 8), "Friends",  NA))))
final_data_untidy <- filter(final_data_untidy, !is.na(id))
final_data_untidy <- mutate(final_data_untidy, interdep_C = scale(interdep, 
                                                                  scale = FALSE,
                                                                  center = TRUE))
